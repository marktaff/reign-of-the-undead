...
Do NOT fork/clone it yet, as things will change wildly as I port this to github, the best I can. I'll update this message when it is safe to tinker.
...
```bash
git clone https://github.com/yourusername/reign-of-the-undead.git